...
def main(
    ...
    g = util.convert_stix2_objects_to_digraph(
        rows,
        drop_dangling_references=True,
    )
    triples = util.convert_digraph_to_triples(g)
...
if __name__ == "__main__":
    def cli():
        ...
        include_attack = kwargs.get('include_attack')
        include_capec = kwargs.get('include_capec')
        include_mbc = kwargs.get('include_mbc')
        include_nist_sp_800_53 = kwargs.get('include_nist_sp_800_53')
        include_attack_to_nist_sp_800_53 = kwargs.get('include_attack_to_nist_sp_800')

        if include_all or not any((include_attack, include_capec, include_mbc, include_nist_sp_800_53, include_attack_to_nist_sp_800_53)):
            kwargs.update({
                'include_attack': True,
                'include_capec': True,
                'include_mbc': True,
