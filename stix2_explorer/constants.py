...
# Default locations of STIX 2 content
MITRE_ATTACK_ENTERPRISE = "MITRE ATT&CK for Enterprise"
...
MITRE_ATTACK_ENTERPRISE_PATH = (
    "~/src/attack-stix-data/enterprise-attack/enterprise-attack.json"
)

MITRE_ATTACK_MOBILE = "MITRE ATT&CK for Mobile"
...
MITRE_ATTACK_MOBILE_PATH = "~/src/attack-stix-data/mobile-attack/mobile-attack.json"
...
MITRE_ATTACK_ICS_PATH = "~/src/attack-stix-data/ics-attack/ics-attack.json"
...
NIST_SP_800_53_PATH = "~/src/attack-control-framework-mappings/frameworks/attack_12_1/nist800_53_r5/stix/nist800-53-r5-controls.json"

MITRE_ATTACK_ENTERPRISE_TO_NIST_SP_800_53 = (
    "MITRE ATT&CK for Enterprise to NIST SP 800-53 mappings"
)
...
MITRE_ATTACK_ENTERPRISE_TO_NIST_SP_800_53_PATH = "~/src/attack-control-framework-mappings/frameworks/attack_12_1/nist800_53_r5/stix/nist800-53-r5-mappings.json"

MITRE_CAPEC = "MITRE CAPEC"
MITRE_CAPEC_URL = (
    "https://raw.githubusercontent.com/mitre/cti/master/capec/2.1/stix-capec.json"
)
MITRE_CAPEC_PATH = "~/src/cti/capec/2.1/stix-capec.json"

MITRE_MBC = "MITRE MBC"
MITRE_MBC_URL = (
    "https://raw.githubusercontent.com/MBCProject/mbc-stix2.1/master/mbc/mbc.json"
)
MITRE_MBC_PATH = "~/src/mbc-stix2.1/mbc/mbc.json"

CTI_STIX_COMMON_OBJECTS_PATH = "~/src/cti-stix-common-objects/objects/*"
...
MITRE_MBC_URL = (
    "https://raw.githubusercontent.com/MBCProject/mbc-stix2/master/mbc/mbc.json"
)
...
NIST_SP_800_53 = "NIST SP 800-53"
MITRE_ATTACK_ENTERPRISE_TO_NIST_SP_800_53 = (
    "MITRE ATT&CK for Enterprise to NIST SP 800-53"
)
